...
@Composable
fun MisReparacionesScreen(userId: Long, token: String) {
            ...
            items(reparaciones) { rep ->
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        if (rep.diagnostico != null) Text("Diagnóstico: ${rep.diagnostico}")
                        if (rep.solucion != null) Text("Solución: ${rep.solucion}")
                        if (rep.costo != null) Text("Costo: ${rep.costo} USD")
                    }
                }
            }
        }
